...
export async function runImportFidelity() {
  ...
  const { archived } = await archiveTradePagesByBrokerPrefix("Fidelity");
  ...
  // Move newly dropped raw files into processed after successful import.
  ...
  return {
    ...
    archivedExistingFidelityRows: archived,
    createdRows: created,
    openRows: open,
    closedRows: closed
  };
